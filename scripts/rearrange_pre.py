...
from omegaconf import OmegaConf  # config manage
...
def make_sim_cfg(agent_dict):
    ...
    sim_cfg.scene_dataset = os.path.join(
        data_path, "hab3_bench_assets/hab3-hssd/hab3-hssd.scene_dataset_config.json"
    )
...
while agent_displ > 1e-9 or agent_rot > 1e-9:
    ...
    action_dict = {
        ...
        "action_args": {"oracle_nav_lookat_action": object_trans, "mode": 1},
    }
